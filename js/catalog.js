...
// конструруктор обьььектов для компонентов
/*
...
//переделать выгрузку в тектсоый фаил для работы  упрошенной

//роутниг  с учетом ошибок  потом  json  с  пустыми данными для блока параметер code для всех от 200 и погнали
//1)выровнять цены
// 2)перезагрузить весь товар
// 3) профиль товара
//4) локализация ошибок
//5)роутинг  https://learn.javascript.ru/template-lodash
//6 спрятать все обработчики
//7) adminka https://github.com/juliaandreevna/PHP_own_blog

//http://www.internet-technologies.ru/scripts/sistema-kompyuternogo-testirovaniya-i-obucheniya-schoolnuke.html